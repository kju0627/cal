...
public class MessageList
     ...
     * @param message
     */
    private void onExtractMessage(MessageInfoHolder message) {
        if (message.folder.name.equals(message.message.getFolder().getAccount().getDraftsFolderName())) {
            ...
            System.out.println("MessageList.java 에서 보낸다 Extractor로 ㅋㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷㄷ");
            //MessageView.actionView(this, ref, messageRefs);
            Extractor.actionView(this, ref, messageRefs, message);
